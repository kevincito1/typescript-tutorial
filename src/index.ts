...
const numero = document.getElementById('number') as HTMLInputElement;
...
form.addEventListener("submit", (ev:Event) => {
    ...
    function verifyNumber(numero : number) {
        if(numero % 2 === 0){
            alert(`${numero} es par`)
        }else{
    ...
    function verifyName(nombre : string){
    ...
    function verifyDayOfWeek(day : number){
     ...
     function verifyNationality(nationality: string){
...
const form2 = document.querySelector('.second-item-form')as HTMLFormElement;
const number1 = document.getElementById('number_1') as HTMLInputElement;
const number2 = document.getElementById('number_2') as HTMLInputElement;
const number3 = document.getElementById('number_3') as HTMLInputElement;

form2.addEventListener('submit', (e:Event) => {
    e.preventDefault();

    function verifyBigger(number1:number, number2:number, number3:number): number {
       if(number1 > number2){
        if(number1 > number3){
            return number1;
        } else {
...
const form3 = document.querySelector('.third-item-form') as HTMLFormElement
const password = document.getElementById("password") as HTMLInputElement;
const check_password = document.getElementById("check_password") as HTMLInputElement;
...
const form4 = document.querySelector(".forth-item-form") as HTMLFormElement;
const month = document.getElementById('month') as HTMLInputElement;

form4.addEventListener("submit", (e:Event)=>{
    e.preventDefault();

    function verifyMonth(month:number){
